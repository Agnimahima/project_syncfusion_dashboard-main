...
const ScrumMaster = () => {
  ...
  const getAllUser=()=>{
    axios.get(`${base_url}/scrummasters`).then((response)=>{
  ...
  const handleRowSelected = (e) => {
    const selectedItems = e.selectedRowIndexes.map((index) => customersData[index].id);
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      ...
      <Header category="Page" title="ScrumMaster" />
      <GridComponent
      ...
      >
        ...
        <ColumnDirective field='projectName' headerText='Project' />
...
export default ScrumMaster;// exporting
